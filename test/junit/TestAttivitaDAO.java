...
public class TestAttivitaDAO {
	...
	public void testDoSave() throws SQLException {
		ArrayList<AttivitaBean> list=new ArrayList<AttivitaBean>();
		list=tester.doRetrieveAll();
		AttivitaBean inserito=list.get(list.size()-1);
		assertEquals("Result", inserito, a4);
	}
	...
	public void testDoUpdate() throws SQLException {
		...
		assertEquals("Result", modificato, a4);
	}

	@Test
	public void testDoRetrieveByKey() {
		assertEquals("Result", a4, tester.doRetrieveByKey(id));
	}

	@Test
	public void testDoDelete() throws SQLException {
		assertEquals("Result", true, tester.doDelete(id));
	}
	...
	public void testDoRetrieveAll() throws SQLException {
		...
		list2.add(a);
		list2.add(a4);
		assertEquals("Result", list2, tester.doRetrieveAll());
	}
